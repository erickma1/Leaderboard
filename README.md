...
Feel free to check the [issues page](https://github.com/erickma1/Leaderboard/issues).
...
This project is [MIT](https://github.com/erickma1/Leaderboard/blob/dev/LICENSE) licensed.
